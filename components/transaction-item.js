  ...
  return (
    <div className="w-full flex items-center">
      <div className="flex items-center mr-4 grow"> 
        <IconComponent className={`mr-4 w-4 h-4 hidden sm:block ${colors}`} />
        <span>{description}</span>
      </div>
      <div className="min-w-[150] items-center hidden md:flex">
        {category && 
          <div className="rounded-md text-xs bg-gray-700 dark:bg-gray-100 
