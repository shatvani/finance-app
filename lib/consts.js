export const types = [
  { value: "income", label: "Income", hu: "Bevétel" },
  { value: "expense", label: "Expense", hu: "Kiadás" },
  { value: "investment", label: "Investment", hu: "Befektetés" },
  { value: "saving", label: "Saving", hu: "Megtakarítás" },
];

export const categories = [
  { value: "salary", label: "Salary", hu: "Fizetés" },
  { value: "freelance", label: "Freelance", hu: "Szabadúszó" },
  { value: "investment", label: "Investment", hu: "Befektetés" },
  { value: "gift", label: "Gift", hu: "Ajándék" },
  { value: "other", label: "Other", hu: "Egyéb" },
  { value: "food", label: "Food", hu: "Étel" },
  { value: "transportation", label: "Transportation", hu: "Közlekedés" },
  { value: "utilities", label: "Utilities", hu: "Közművek" },
  { value: "entertainment", label: "Entertainment", hu: "Szórakozás" },
  { value: "health", label: "Health", hu: "Egészség" },     
  { value: "shopping", label: "Shopping", hu: "Vásárlás" },
  { value: "education", label: "Education", hu: "Oktatás" },
  { value: "travel", label: "Travel", hu: "Utazás" },
  { value: "personal_care", label: "Personal Care", hu: "Személyes gondoskodás" },
  { value: "housing", label: "Housing", hu: "Lakhatás" },
  { value: "insurance", label: "Insurance", hu: "Biztosítás" },
  { value: "taxes", label: "Taxes", hu: "Adók" },
  { value: "debt_repayment", label: "Debt Repayment", hu: "Adósságtörlesztés" },
];
